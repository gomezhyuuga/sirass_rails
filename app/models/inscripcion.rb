...
class Inscripcion < ActiveRecord::Base
  ...
  validates_presence_of :prestador_id, :institucion_id, :plantel_id, :carrera, :matricula, :semestre, :avance_cursos, :promedio, :programa_institucional, :cve_programa_institucional, :cprograma_id, :fecha_inicio, :fecha_fin, :responsable, :difundir, :dia_ids
