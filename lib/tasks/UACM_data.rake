...
namespace :db do
	namespace :uacm do
		...
		task user: :environment do
			Admin.create!(nombre: "Martha",aPaterno: "Tera",aMaterno: "Ponce",nacimiento: "24/04/1988",cargo: "Responsable de Servicio Social",user_attributes: {username: "marthag",email: "marthag@hotmail.com",password: "foobar",password_confirmation: "foobar"})
		end
